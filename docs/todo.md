...
- [x] Add shared UI primitives for cards, tables, forms, dialogs, badges.
...
- [ ] Generate TypeScript database types if time allows.
...
- [x] Prepare a clean demo seed and walkthrough script.
...
- [ ] Appointment rescheduling and cancellation UI.
