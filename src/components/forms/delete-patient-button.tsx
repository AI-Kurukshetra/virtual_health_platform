...
import { deletePatientAction, type ActionState } from "@/app/org/[slug]/actions";
      ...
      {showConfirm && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/50 backdrop-blur-sm p-4 animate-in fade-in duration-200 text-left">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-6 relative">
            <h3 className="text-lg font-bold text-slate-900 tracking-tight">Delete {patientName}?</h3>
            <p className="text-sm text-slate-500 font-medium mt-2 leading-relaxed">
              Are you sure you want to delete this patient profile? All their records will be permanently removed. This action cannot be undone.
            </p>
